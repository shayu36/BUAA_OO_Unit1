...
public class Poly {
    ...
    private ArrayList<Mono> compactWithMap(ArrayList<Mono> monos) {
        ...
        for (Map.Entry<String, BigInteger> entry : coeffMap.entrySet()) {
            ...
            res.add(new Mono(sum, rep.getxexp(), rep.getExpPoly()));
        }
        return res;
    }
    ...
    public Poly powPoly(BigInteger exp) {
        ...
        init.add(new Mono(BigInteger.ONE, BigInteger.ZERO)); // 1
    ...
    public BigInteger coefficientGcd() {
        ArrayList<Mono> list = compactList(this.getMonoList());
        ...
        return g.equals(BigInteger.ZERO) ? BigInteger.ONE : g;
    }
    ...
    @Override//还需要处理性能优化的问题 exp等等
    public String toString() {
        ArrayList<Mono> res = compactList(this.getMonoList());
    ...
    public boolean equals(Object obj) {
        ...
        Poly other = ((Poly) obj).copy().normalize();
        Poly thisPoly = this.copy().normalize();
        return thisPoly.canonicalKey().equals(other.canonicalKey());
    }
